...
class DataIngestion:
    ...
    def export_data_into_feature_store(self)->DataFrame:
        ...
        Descriotion: This method exports data from mongodb to csv file

        output : data is returned as artifact of data ingestion components
        on Failure : Write  an exception log and then reaise an exception
        """
        ...
        try:
            ...
            logging.info(f"Saving exported data into features store file path: {feature_store_file_path}")
    ...
    def split_data_as_train_test(self,dataframe: DataFrame) -> None:
        ...
        try:
            train_set, test_set = train_test_split(dataframe, 
                                                   test_size=self.data_ingestion_config.train_test_split_file_ratio)
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        ...
        try:
            ...
            logging.info(
                "Exited initiate_data_ingetsion method of Data_Ingestion class"
            )
